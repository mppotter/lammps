...
OBJS = $(OBJ_DIR)/lal_atom.o $(OBJ_DIR)/lal_ans.o \
       ...
       $(OBJ_DIR)/lal_lj_bump.o $(OBJ_DIR)/lal_lj_bump_ext.o \
...
CBNS = $(OBJ_DIR)/device.cubin $(OBJ_DIR)/device_cubin.h \
       ...
       $(OBJ_DIR)/lj_bump.cubin $(OBJ_DIR)/lj_bump_cubin.h \
...
$(OBJ_DIR)/lj_bump.cubin: lal_lj_bump.cu lal_precision.h lal_preprocessor.h
...
$(OBJ_DIR)/lal_lj_bump_ext.o: $(ALL_H) lal_lj_bump.h lal_lj_bump_ext.cpp lal_base_atomic.h
	$(CUDR) -o $@ -c lal_lj_bump_ext.cpp -I$(OBJ_DIR)
